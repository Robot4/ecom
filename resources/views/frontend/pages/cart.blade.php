                                ...
                                @foreach (Helper::getAllProductFromCart() as $key => $cart)
                                    <tr>
                                        ...
                                        <td class="price" data-title="Price">
                                            <span>{{ number_format($cart['price'], 0) }} Dhs</span>
                                        </td>
                                        <td class="size" data-title="size">
                                            <span>{{ $cart->selected_size ?? 'Not specified' }}</span>
                                        </td>
                                        <!-- Include selected_size as hidden input in your form -->
                                        <input type="hidden" name="selected_size[]" value="{{ $cart->selected_size }}">
                                        ...
                                        <td class="total-amount cart_single_price" data-title="Total">
                                            <span class="money">{{ $cart['amount'] }} Dhs</span>
                                        </td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">vous payez<span>{{number_format($total_amount,0)}} Dhs</span></li>
										@else
											<li class="last" id="order_total_price">vous payez<span>{{number_format($total_amount,0)}} Dhs</span></li>
										@endif
									</ul>
