									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount,0)}} Dhs</span><s>{{number_format($product_detail->price,0)}} Dhs</s> </p>
                                            ...
                                            @if($product_detail->size)
                                                <div class="size mt-4">
                                                    <h4>Size</h4>
                                                    <select name="selected_size" id="selected_size" required>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">{{number_format($data->price,0)}} Dhs</span>
