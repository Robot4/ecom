...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Prix Dhs<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <select name="size[]" id="selected_size" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XXL"  @if( in_array( "XXL",$data ) ) selected @endif>Double Extra Large</option>
