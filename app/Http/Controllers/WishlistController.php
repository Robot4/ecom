...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request){
        ...
        $already_wishlist = Wishlist::where('user_id', auth()->user()->id)->where('cart_id',null)->where('product_id', $product->id)->where('selected_size', $request->selected_size)->
first();
        ...
        if($already_wishlist) {
            ...
            $wishlist->selected_size = $request->selected_size;
